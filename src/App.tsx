      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 auto-rows-auto md:auto-rows-[220px]">
          ...
          <BentoCard colSpan="md:col-span-2" rowSpan="md:row-span-2" delay={0}>
            <div className="flex flex-col justify-between h-full">
              <div className="space-y-4">
                ...
                <div className="text-neutral-400 text-sm leading-relaxed max-w-lg">
          ...
          <BentoCard colSpan="md:col-span-1" className="bg-white/5" delay={0.4}>
            <div className="flex items-center justify-center h-full">
              <div className="text-center">
                <p className="text-xl font-medium text-neutral-400 italic">
          ...
          >
            ...
            <div className="relative z-10 h-full flex flex-col">
              ...
              <div className="space-y-4 overflow-y-auto px-3 pb-6 flex-1 min-h-0 mask-linear-gradient-bottom [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-neutral-700 [&::-webkit-scrollbar-thumb]:rounded-full">
                {PORTFOLIO_CONTENT.experience.map((role, idx) => (
                  <div key={idx} className="relative pl-4 border-l border-white/10 last:mb-0">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 text-blue-400 font-medium text-sm">
                          ...
                          <div className="flex gap-2">
                            {role.companyUrl && (
                              <a href={role.companyUrl} target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 text-gray-200 transition-colors">
                                <Globe size={12} />
                              </a>
                            )}
                            {role.linkedin && (
                              <a href={role.linkedin} target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 text-gray-200 transition-colors">
                                <Linkedin size={12} />
                              </a>
                            )}
                          </div>
                    ...
                    {role.description && <p className="text-xs text-neutral-400 mb-2 max-w-lg">{role.description}</p>}
                    {idx === 0 && (
                      <div className="inline-flex items-center text-[10px] bg-white/10 border border-white/20 py-1 px-2 rounded-md text-white gap-1 mt-2">
        ...
        <div className="mt-16 w-full">
          <div className="mb-6 px-4 md:px-6">
            ...
            <p className="text-neutral-500 text-sm mt-1 pb-15">Building and giving back to the community.</p>
          </div>
